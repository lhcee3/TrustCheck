    ...
    <div className="min-h-screen bg-[#F7F6F2] flex flex-col">
      ...
      <div className="flex-1 px-4 py-4 pb-8 flex flex-col gap-2">
        {loading ? (
          ...
          <button key={n.id} onClick={() => markRead(n.id)} className={`w-full text-left bg-white rounded-2xl border p-4 flex items-start gap-3 transition-colors ${n.read ? "border-stone-100 opacity-70" : "border-stone-200 shadow-sm"}`}>
